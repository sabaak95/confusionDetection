...
name = '/scratch/mabbasib/MLLOGS/log' + (''.join(sys.argv[1:]))
if args.cont:
    logF = name+'con' + '.csv'
    netS2 = name + '.pth'
    netS = name+'con' + '.pth'
...
if __name__ == '__main__':
    ...
    DT_tr = MakeH_ra(b, transform=transform, val=0,Len=args.Len)
    DT_va = MakeH_ra(c, transform=transformV, val=1,Len=args.Len)
