...
def reslog(line):
    ...
    with open(r'/home/mabbasib/MLN/logs/ACC_F_RI1_9.csv', 'a', newline='') as f:
        writer = csv.writer(f)
...
if __name__ == '__main__':
    ...
    aR, bR, cR = datPP3_r(root_dir='./Real/',Ra=args.Ra)
    aI, bS, cS = datPPI32(root_dir='./all_emo/')
    # DT_trS = MakeHI(aI, transform=transform, Len=args.Len)
    DT_trS = MakeHIratio(aI, transform=transform, Len=args.Len,ratio=args.ratio)
    ...
    ######################################################################
    if args.ratio==1 and args.Len==64:
        num_epochs=args.numepc//2
    else:
    ...
    reslog([args.ratio,args.BS,args.JobId,args.NN,args.hids,args.mode,args.Frz,args.cont,args.reduction,args.reduction3,args.Ra,args.Len,args.numepc,args.patience,args.Sc,args.wd,args.lr,111,preM, recM, fsM,J_s,best_acc])